...
export const SystemSpecs: React.FC = () => {
    ...
    const modelsData: Record<string, any> = {
        v1: {
            ...
            desc: t('sys_v1_desc'),
            heroImg: '/V1 Website_Fiat,Citroen,Peugeot,Opel/20201221_103500.jpg',
            gallery: [
        ...
        v4: {
            ...
            desc: t('sys_v4_desc'),
            heroImg: '/V4 Website_Renault/20190806_103915.jpg',
            gallery: [
        ...
        v5: {
            ...
            desc: t('sys_v5_desc'),
            heroImg: '/V5 Website_Ford/20190512_170902.jpg',
            gallery: [
        ...
        v8: {
            ...
            desc: t('sys_v8_desc'),
            heroImg: '/V8 Website_Mercedes Benz/20220619_134121.jpg',
            gallery: [
        ...
        <section className="configurator-section">
            <div className="configurator-container">
                ...
                <div className="configurator-header">
                    ...
                    <div className="logo-switcher-track">
                        {vehicleLogos.map((vehicle) => (
                            <button 
                                key={vehicle.id}
                                className={`logo-switcher-btn ${activeVehicle.id === vehicle.id ? 'active' : ''}`}
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            ...
                            <div className="model-info-block">
                                <h2 className="model-title">{activeModel.title}</h2>
                                ...
                                <p className="model-desc">{activeModel.desc}</p>
                            </div>
                                    ...
                                    {allImages.map((img: string, idx: number) => {
                                        ...
                                        return (
                                            <div key={idx} className="gallery-grid-item" onClick={() => setCurrentImageIndex(idx)}>
                                                <img src={img} alt={`${activeModel.title} Detail ${idx}`} loading="lazy" />
                                            </div>
                                        );
                                    })}
                                </div>
