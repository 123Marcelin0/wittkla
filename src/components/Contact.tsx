...
import './Contact.css'; // Make sure this is imported
            ...
            <div className="contact-container">
                <div className="contact-grid">
                    ...
                    <div className="contact-left">
                        <span className="contact-label">{t('contact_label')}</span>
                        ...
                        <div className="contact-links-grid">
                            ...
                            {/* Instagram */}
                            <a href="https://www.instagram.com/wittkla" target="_blank" rel="noopener noreferrer" className="direct-contact-btn instagram">
                                <svg viewBox="0 0 24 24">
                    ...
                    <div className="contact-right">
                        <form className="contact-form">
                            <div className="form-group">
                                ...
                                <input type="text" className="form-input" placeholder={t('contact_form_name_ph')} />
                            </div>

                            <div className="form-group">
                                <label className="form-label">{t('contact_form_email')}</label>
                                <input type="email" className="form-input" placeholder="info@wittkla.com" />
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                <textarea className="form-textarea" rows={4} placeholder={t('contact_form_msg_ph')}></textarea>
                            </div>

                            <MagneticButton className="submit-btn" style={{marginTop: '1rem'}}>
                                {t('contact_submit')}
                            </MagneticButton>
                        </form>
                    </div>
